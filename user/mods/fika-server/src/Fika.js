...
let Fika = class Fika {
    ...
    dedicatedConfig;
    backgroundConfig;
    constructor(databaseServer, overrider, fikaServerTools, fikaConfig, fikaDedicatedProfileService, imageRouter, importerUtil) {
